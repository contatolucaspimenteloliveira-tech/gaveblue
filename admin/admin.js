(() => {
  ...
  function openOrganizationForm(org = null) {
    ...
    $('#org-name').value = org?.name || ''; $('#org-slug').value = org?.slug || ''; $('#org-status').value = org?.status || 'trial'; $('#org-legal-name').value = org?.legal_name || ''; $('#org-document').value = org?.document || ''; $('#org-logo-url').value = org?.logo_url || ''; $('#org-primary-color').value = org?.primary_color || '#2563eb'; $('#org-secondary-color').value = org?.secondary_color || '#7c3aed'; $('#org-address').value = org?.metadata?.address || ''; $('#org-support-email').value = org?.metadata?.supportEmail || ''; $('#org-whatsapp').value = org?.metadata?.whatsapp || ''; $('#org-instagram').value = org?.metadata?.instagramUrl || '';
