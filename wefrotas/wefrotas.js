    ...
    function getFinanceBlockedTooltip(action, entries) {
      ...
      if (!count) {
        const emptyMessages = {
          ...
          close: 'Fechar despesa: selecione 1 abastecimento ou agrupamento pendente.',
      ...
      if (action === 'close') {
        ...
        if (!(isFuelEntry(firstEntry) || isFuelGroupEntry(firstEntry))) {
          return 'Fechar despesa: selecione um abastecimento ou agrupamento.';
        }
