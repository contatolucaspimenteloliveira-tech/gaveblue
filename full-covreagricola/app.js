...
const CLOUDINARY_UPLOAD_PRESET = 'comprovantes_moyses';
const CLOUDINARY_UPLOAD_URL = `https://api.cloudinary.com/v1_1/${CLOUDINARY_CLOUD_NAME}/image/upload`;
const FUEL_WHATSAPP_NUMBER = '5527999880096';
const LAST_FUEL_ENTRY_STORAGE_KEY = 'full-covreagricola:last-fuel-entry';
...
async function uploadFuelReceiptToCloudinary(file, metadata) {
  ...
  formData.append('folder', 'comprovantes_moyses');
...
function openWhatsAppSuggestions() {
  ...
  const urlWhatsApp = `https://wa.me/${FUEL_WHATSAPP_NUMBER}?text=${encodeURIComponent(mensagem)}`;
