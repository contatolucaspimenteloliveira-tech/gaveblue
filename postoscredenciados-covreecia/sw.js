const CENTRAL_RELEASE = '20260824-onboarding-camera-recovery-1';
...
const STATIC_ASSETS = [
  './',
  './index.html',
  './styles.css?v=20260824-onboarding-camera-recovery-1',
  './app.js?v=20260824-onboarding-camera-recovery-1',
